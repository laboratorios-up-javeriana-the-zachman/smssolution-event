...
event_select.create = async function (event) {
    ...
    let initial_date = moment(event.campaing.initial_date, 'YYYY-MM-DD HH:mm:ss');

    event.campaing.parameters.forEach(element => {
...
async function get_frecuency() {
        ...
        const options = {
            encoding: 'utf8',
            uri: 'http://smssolutions-campaign:3000/parameter?type_id=' + frecuency,
            json: true,
            method: 'GET',
